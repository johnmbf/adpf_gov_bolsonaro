...
O artigo-produto da pesquisa foi submetido para publicação e o preprint pode ser obtido em no [ReserachGate](https://www.researchgate.net/publication/371952303_A_POLITIZACAO_DO_JUDICIARIO_UMA_POLITICA_DE_JUDICIALIZACAO_DA_POLITICA?_sg%5B0%5D=PEzOgh5rg8deKI8NcKQA6ol1hlNrYLmbCeAqyR0K3nM1djEy1daHGd9M3ACijxFH6QJBQ57hSV8gJaFsBlZ9bgk862myZwaTjJOCjd5I.HNYbkRyvm0K4I5ERkKIoCkssxQnp5BPDMZtmmsr7CqGLuhxaOQMVB91BI-U24oI9OBudEqV_K_I8hHZaoaygpQ).
...
Salvamos os arquivos em `.csv` para serem utilizados por quem não usa o R:
...
O primeiro tratamento realizado foi na tabela_info. Dividimos os assuntos (que estavam agrupados em uma única observação por coluna) e colocamos cada assunto em uma coluna própria e depois empilhamos as observações. Por fim, removemos os espaços desnecessários, as observações vazias ou com string em branco e deletamos os valores duplicados. A coluna ajuizamento foi transformada no tipo `date`.
